 ...
 */
final class Version20220827180022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program DROP category_id, DROP country, DROP year');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD category_id INT NOT NULL, ADD country VARCHAR(255) NOT NULL, ADD year INT NOT NULL');
